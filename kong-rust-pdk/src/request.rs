...
// TODO better way enum -> str?
// const GET_SCHEME: &str = "kong.request.get_scheme";
const GET_METHOD: &str = "kong.request.get_method";
...
impl Request for PbServerRequest {
    ...
    async fn get_method(&self) -> Result<String, Error> {
        ...
        // TODO error type
        self.stream.write_method(GET_METHOD).await.unwrap();
